...
function MarketStatusBadge() {
  ...
  return (
    <Link
      ...
      title="Open markets"
      className={cn(
        'hidden items-center gap-2 rounded-lg border px-3 py-1.5 text-xs font-semibold transition sm:flex',
        open
          ? 'border-emerald-500/20 bg-emerald-500/[0.08] text-emerald-300 hover:bg-emerald-500/[0.12]'
          : 'border-white/10 bg-white/[0.04] text-white/42 hover:bg-white/[0.08]'
      )}
    >
...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-white/[0.06] bg-[#0A0A0A]/80 backdrop-blur-2xl transition-colors duration-300">
